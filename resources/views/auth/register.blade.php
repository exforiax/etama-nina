...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url({{ asset('template/Admin/src') }}/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box row text-center">
                <div
                    class="col-lg-7 col-md-5 bg-white d-flex no-block justify-content-center align-items-center position-relative">
