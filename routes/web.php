...
Route::get('/tentang-kami/sekilas', [HomeController::class, 'sekilas'])->name('tentang.sekilas');
Route::get('/tentang-kami/visi-misi', [HomeController::class, 'visi_misi'])->name('tentang.visi.misi');
Route::get('/tentang-kami/struktur-organisasi', [HomeController::class, 'struktur_organisasi'])->name('tentang.struktur');
Route::get('/kontak-kami', [HomeController::class, 'kontak_kami'])->name('kontak.kami');
